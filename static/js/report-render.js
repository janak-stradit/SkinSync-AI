...
function buildAiAnalysisHtml(report) {
    const cached = report.ai_analysis
    ...
    return `
        ...
        <div class="report-ai-section" data-report-id="${report.id}">
            <button type="button" class="btn-secondary btn-with-spinner report-ai-btn" ${report.ai_analysis ? 'style="display:none;"' : ''}>
...
function buildReportPageHtml(report) {
    return `
        <div class="report-page-grid">
            ...
            <div class="report-page-card report-intake-slot">
